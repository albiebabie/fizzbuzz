...
describe 'fizzbuzz' do # describe block, trying do describe our fizzbuzz method
...
#First prepare the data, then perform some action and at the end make sure what you were expecting hapened.
